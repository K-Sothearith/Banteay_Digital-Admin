  ...
  return (
    <main className="maintenance-page">
      ...
      <section className="maintenance-content">
        <div className="maintenance-copy">
          <div className="maintenance-eyebrow">
            ...
            <span>áž€áž¶ážšáž•áŸ’áž¢áž¶áž€áž‡áž¶áž”ážŽáŸ’ážŠáŸ„áŸ‡áž¢áž¶ážŸáž“áŸ’áž“</span>
          </div>
          ...
          <p className="maintenance-lead">
            ...
            Weâ€™ll be backâ€”safer, sharper, and ready to protect your digital world.
          </p>
          <p className="maintenance-khmer" lang="km">
            áž”áž“áŸ’áž‘áž¶áž™ážŒáž¸áž‡áž¸ážáž›áž€áŸ†áž–áž»áž„ážŸáž˜áŸ’ážšáž¶áž€áž‡áž¶áž”ážŽáŸ’ážŠáŸ„áŸ‡áž¢áž¶ážŸáž“áŸ’áž“áŸ” áž™áž¾áž„áž“áž¹áž„ážáŸ’ážšáž¡áž”áŸ‹áž˜áž€ážœáž·áž‰áž€áŸ’áž“áž»áž„áž–áŸáž›áž†áž¶áž”áŸ‹áŸ—áž“áŸáŸ‡
            ážŠáž¾áž˜áŸ’áž”áž¸áž”áž“áŸ’ážáž€áž¶ážšáž–áž¶ážšáž–áž·áž—áž–ážŒáž¸áž‡áž¸ážáž›ážšáž”ážŸáŸ‹áž¢áŸ’áž“áž€áŸ”
          </p>
        ...
        <div className="maintenance-visual" aria-hidden="true">
          ...
          <div className="maintenance-float-card maintenance-float-card--bottom">
            <span className="maintenance-float-card__clock">â€¢â€¢â€¢</span>
            <div>
      ...
      <footer className="maintenance-footer">
        <span>Â© {new Date().getFullYear()} Banteay Digital</span>
